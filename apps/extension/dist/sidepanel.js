...
(() => {
  ...
  async function getContext(appUrl, token) {
  ...
  async function importResult(appUrl, token, body) {
  ...
  async function decide(appUrl, token, resultId, decision, notes) {
  ...
  function App() {
    ...
    const [view, setView] = (0, import_react.useState)("pair");
    const [appUrl, setAppUrl] = (0, import_react.useState)("");
    ...
    const [lastResultId, setLastResultId] = (0, import_react.useState)(void 0);
    const [revisionNotes, setRevisionNotes] = (0, import_react.useState)("");
    const refresh = (0, import_react.useCallback)(async (url, tok) => {
      setError("");
      try {
    ...
    const detectResults = run("Detect", async () => {
      ...
      if (!resp.ok) throw new Error(resp.error ?? "Detection failed.");
      setMessage(`Detected ${resp.count} result(s). Select one on the page.`);
    });
    const sendSelected = run("Send result", async () => {
      if (!task) throw new Error("No active task.");
      const resp = await sendToTab({ type: "GET_SELECTED_RESULT" });
      if (!resp.ok) throw new Error(resp.error ?? "No result selected.");
      const result = resp.result;
      const body = result.src.startsWith("data:") ? { taskId: task.taskId, kind: result.kind, source: "extension", dataUrl: result.src } : { taskId: task.taskId, kind: result.kind, source: "extension", sourceUrl: result.src };
    ...
    function decideOn(decision) {
      return run("Decision", async () => {
        if (!lastResultId) throw new Error("Import a result first.");
        await decide(appUrl, token, lastResultId, decision, revisionNotes || void 0);
        setMessage(`Marked: ${decision.replace("_", " ")}.`);
      });
    }
    if (!ready) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.muted, children: "Loading\u2026" });
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", { style: s.h1, children: [
        "SCENE",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.amber, children: "ARC" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.muted, children: view === "main" ? account : "Companion extension" }),
      error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { ...s.card, color: "var(--danger)" }, children: error }) : null,
      message ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { ...s.card, color: "var(--amber)" }, children: message }) : null,
      view === "pair" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.card, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Pair with SceneArc" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.muted, children: "In SceneArc \u2192 Settings \u2192 Chrome extension, generate a code. Then enter your SceneArc web address and the code here." }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "SceneArc URL" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "Pairing code" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            style: s.input,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 10 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, onClick: handlePair, disabled: busy, children: busy ? "Pairing\u2026" : "Pair" }) })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        task ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: s.amber, children: task.projectTitle }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.muted, children: [
            task.sceneNumber ? `Scene ${task.sceneNumber}` : "No scene",
            task.sceneSlugline ? ` \xB7 ${task.sceneSlugline}` : "",
            " \xB7 ",
            task.status
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "Prepared prompt" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: s.pre, children: task.prompt }),
          task.references.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "References" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { style: { margin: 0, paddingLeft: 18, fontSize: 12 }, children: task.references.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
              r.label,
              r.required ? "" : " (optional)"
            ] }, i)) })
          ] }) : null
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: s.card, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: s.muted, children: "No active task. In SceneArc, open a scene \u2192 create a prompt package \u2192 \u201CSend to extension\u201D, then press Refresh here." }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: { fontSize: 13 }, children: "Workflow" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnSecondary, onClick: copyPrompt, disabled: busy || !task, children: "Copy Prompt" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnSecondary, onClick: insertPrompt, disabled: busy || !task, children: "Insert Prompt" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnSecondary, onClick: detectResults, disabled: busy, children: "Detect Results" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, onClick: sendSelected, disabled: busy || !task, children: "Send Selected" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "Manual upload (if auto-import fails)" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              type: "file",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: { fontSize: 13 }, children: "Decision on last imported result" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, onClick: decideOn("approved"), disabled: busy || !lastResultId, children: "Approve" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: s.label, children: "Revision notes" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              style: s.input,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              style: s.btnSecondary,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnSecondary, onClick: handleDisconnect, disabled: busy, children: "Disconnect" })
        ] })
      ] })
    ] });
  }
  ...
  if (container) {
    (0, import_client.createRoot)(container).render(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(App, {}));
  }
})();
